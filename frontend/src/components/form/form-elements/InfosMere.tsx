    ...
    <ComponentCard title="معلومات الأم">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="flex items-center gap-2 md:col-span-2">
          ...
          />
          <Label htmlFor="decedee">الأم متوفية</Label>
        </div>
 <div className="flex flex-col">
        ...
        {estDecedee ? (
          <div className="flex flex-col mt-2 md:col-span-2">
            <BirthDateInput id="birthDateMereDecedee" label="تاريخ وفاة الأم" />
          </div>
        ) : (
          <>
            {/* Nom */}
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <Label htmlFor="travaille">الأم تعمل</Label>
            </div>
         ...
         <div className="md:col-span-2 mt-4">
                       <DropzoneComponent label="صورة الام" id="photoMere" />
                     </div>
                   </>
                 )}
