...
var VirtualScroller = React11.memo(React11.forwardRef(function(inProps, ref) {
  ...
  var viewInitialized = React11.useRef(false);
...
var DropdownItem = React13.memo(function(props) {
  ...
  return React13.createElement("li", _extends7({
    key: props.label
  }, itemProps), checkmark && iconRenderer(), React13.createElement("span", itemGroupLabelProps, content), React13.createElement(Ripple, null));
});
...
var Dropdown = React13.memo(React13.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React13.useState(false), _React$useState2 = _slicedToArray2(_React$useState, 2), focusedState = _React$useState2[0], setFocusedState = _React$useState2[1];
  var _React$useState3 = React13.useState(-1), _React$useState4 = _slicedToArray2(_React$useState3, 2), focusedOptionIndex = _React$useState4[0], setFocusedOptionIndex = _React$useState4[1];
  var _React$useState5 = React13.useState(false), _React$useState6 = _slicedToArray2(_React$useState5, 2), overlayVisibleState = _React$useState6[0], setOverlayVisibleState = _React$useState6[1];
  ...
  var flatOptions = function flatOptions2(options) {
    return (options || []).reduce(function(result, option, index) {
      result.push(_objectSpread3(_objectSpread3({}, option), {}, {
        group: true,
        index
      }));
  ...
  var createLabel = function createLabel2() {
    ...
    var content = props.valueTemplate ? ObjectUtils.getJSXElement(props.valueTemplate, selectedOption, props) : label || props.placeholder || props.emptyMessage || React13.createElement(React13.Fragment, null, " ");
  ...
  var createDropdownIcon = function createDropdownIcon2() {
    ...
    var icon = !overlayVisibleState ? props.dropdownIcon || React13.createElement(ChevronDownIcon, dropdownIconProps) : props.collapseIcon || React13.createElement(ChevronUpIcon, dropdownIconProps);
...
//# sourceMappingURL=chunk-XM43SD7M.js.map
