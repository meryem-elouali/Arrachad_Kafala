                      ...
                      <div className="flex gap-4">
                           ...
                           {famille.pere?.photoPere && (
                             <div className="w-20 h-20 overflow-hidden border border-gray-200 rounded-full">
                                 <img
                                                               src={toBase64(famille.pere?.photoPere) ?? '/placeholder.jpg'}
                                                               alt="Père"
                         ...
                         <div className="w-24 h-24 rounded-full overflow-hidden border border-gray-300 flex items-center justify-center bg-gray-100">
                           {famille.mere?.photoMere ? (
                             ...
                             <p className="text-xs text-gray-500 text-center">Aucune photo</p>
                           )}
                         </div>
/**<div className="w-20 h-20 rounded-full overflow-hidden border border-gray-200 flex items-center justify-center bg-gray-100">
     {famille.mere?.photoMere ? (
       <img
         src={`data:image/jpeg;base64,${famille.mere.photoMere}`}
         alt="Mère"
         className="w-full h-full object-contain"  // <-- clé ici
       />
     ) : (
                           ...
                           {famille.enfants?.map(
                             (enfant) =>
                               enfant.photoEnfant && (
                                 ...
                                 >
                                   <img
                                     src={toBase64(enfant.photoEnfant)}
                                     alt={enfant.prenom}
                                     className="object-cover w-full h-full"
                                   />
                                 </div>
